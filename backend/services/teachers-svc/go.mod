module github.com/fizcultor/backend/services/teachers-svc

go 1.23.0

require (
	github.com/fizcultor/backend/gen v0.0.0
...
replace (
	...
	github.com/fizcultor/backend/tests/testhelpers => ../../tests/testhelpers
	// Workaround: prometheus/common test deps подтягивают rogpeppe/go-internal
	// v1.15.0, требующий go 1.25. Пинним v1.13.1 (последний с go 1.22), чтобы
	// сборка шла на go 1.23 как в Dockerfile.svc и CI.
